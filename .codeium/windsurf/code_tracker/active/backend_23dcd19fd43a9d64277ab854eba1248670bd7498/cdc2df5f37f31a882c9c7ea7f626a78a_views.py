...
class SiteSettingsView(GenericAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        cache.delete('site_settings')
        return Response(status=HTTP_204_NO_CONTENT)
� *cascade08��*cascade08�� *cascade08��*cascade08�� *cascade08��*cascade08�� *cascade08��*cascade08��V *cascade08"(23dcd19fd43a9d64277ab854eba1248670bd74982%file:///root/backend/oj_user/views.py:file:///root/backend