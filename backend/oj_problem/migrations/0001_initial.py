    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.IntegerField(default=0, help_text='level: 0 to 9, corresponds to black iron ~ king', verbose_name='difficulty')),
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='problems', to='oj_problem.tags', verbose_name='tags')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem_solve', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
