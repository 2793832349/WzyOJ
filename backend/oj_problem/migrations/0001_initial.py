    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.IntegerField(default=0, help_text='level: 0 to 10, corresponds to unset ~ king', verbose_name='difficulty')),
                ...
                ('judge_mode', models.CharField(choices=[('acm', 'ACM'), ('leetcode', 'LeetCode')], default='acm', max_length=20, verbose_name='judge mode')),
                ('leetcode_templates', models.JSONField(default=oj_problem.models.get_default_leetcode_templates, verbose_name='leetcode templates')),
            ],
            options={
